...
test_messages = [
    ...
    [101, 1, 3, datetime.datetime.now() + timedelta(seconds=1), "Ganz schön leer hier, lass uns noch jemanden einladen"],
    [102, 1, 4, datetime.datetime.now() + timedelta(seconds=2), "Nee, lass mal"],
    [103, 1, 1, datetime.datetime.now() + timedelta(seconds=3), "Vielleicht später Frank"],

    [104, 2, 10, datetime.datetime.now() + timedelta(seconds=1), "Hi ihr beiden"],
    [105, 2, 7, datetime.datetime.now() + timedelta(seconds=2), "Hey"],
    [106, 2, 8, datetime.datetime.now() + timedelta(seconds=3), "Hi"],
    [107, 2, 10, datetime.datetime.now() + timedelta(seconds=4), "Möchten wir uns nach der nächsten Vorlesung mal irgendwo zusammen hinsetzen?"],
    [108, 2, 7, datetime.datetime.now() + timedelta(seconds=5), "Gerne"],
    [109, 2, 8, datetime.datetime.now() + timedelta(seconds=6), "Gerne. Vielleicht in der Kaffeteria? Kann aber erst 20 Minuten nach der Vorlesung da sein."]
]
