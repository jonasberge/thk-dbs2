...
-- region [Test-Gruppe] Funktion GruppenBeitragVerfassen
...
SELECT 1, 'Frank', 'frank@th-koeln.de', 'h', 'Ich mag Informatik.', 1, 1, NOW() FROM dual;
...
CALL GruppenBeitragVerfassen('USER', 'Lel', 1, 1);
